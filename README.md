...
```
$ composer require mosibooms/dcat-iframe-tab
```
...
## 更新
相关更新内容请关注github的`tag`，里面有每个版本详细的更新：[https://github.com/mosibooms/dcat-iframe-tab/releases](https://github.com/mosiboom/dcat-iframe-tab/releases)

基本迭代更新命令：
```apacheconfig
composer remove mosibooms/dcat-iframe-tab
composer require mosibooms/dcat-iframe-tab:版本号
...
```html
<a iframe-extends=true iframe-tab=true href="https://github.com/mosibooms/dcat-iframe-tab">添加新的标签页</a>
```
